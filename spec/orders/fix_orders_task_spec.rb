...
describe 'fix orders' do
  ...
  before do
    ...
    stub_request(:get, %r{.*audit-data/acquisition/order-line/28801a5f-396c-48c1-8f6b-cb92f5d428d1.*})
      .to_return(status: 200, body: { 'orderLineAuditEvents' =>
