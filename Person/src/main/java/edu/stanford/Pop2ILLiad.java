              ...
              try {
                ...
                for (int u = 0; u < users.size(); u++) {
                  ...
                  for (int d = 0; d < departments.size(); d++) {
                    if (departments.getJsonString(d).toString().equals("Graduate School of Business (GSB)")) {
                      NVTGC = "S7Z";
                    } else {
                      NVTGC = "STF";
                    }
                  ...
                  if (expiryDateJson != null) {
                    expiry = sdf.parse(expiryDateJson.toString().replace("\"",""));
                  }
                  ...
                  illData.put("LastName", "'" + obj.getJsonObject("personal").getJsonString("lastName").getString() + "'"); //40 *
                  illData.put("FirstName", "'" + obj.getJsonObject("personal").getJsonString("firstName").getString() + "'"); //40 *
                  illData.put("SSN", "'" + obj.getJsonString("barcode").getString() + "'"); //20
                  illData.put("Status", "'" + obj.getJsonString("patronGroup").getString() + "'"); //15
                  ...
                  illData.put("UserInfo1", "'" + obj.getJsonString("externalSystemId").getString() + "'"); //
