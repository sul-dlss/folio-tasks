              ...
              try {
                ...
                for (int u = 0; u < users.size(); u++) {
                  try {
                    ...
                    illData.put("LastName", "'" + obj.getJsonObject("personal").getJsonString("lastName").getString().replaceAll("[\'\"]", "") + "'"); //40 *
                    illData.put("FirstName", "'" + obj.getJsonObject("personal").getJsonString("firstName").getString().replaceAll("[\'\"]", "") + "'"); //40 *
