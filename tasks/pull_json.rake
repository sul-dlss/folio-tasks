...
namespace :configurations do
  ...
  modules = %i[BULKEDIT CHECKOUT FAST_ADD ORDERS ORG SMTP_SERVER TENANT USERSBL]
  ...
  desc 'pull configurations for specified module: BULKEDIT CHECKOUT FAST_ADD ORDERS ORG SMTP_SERVER TENANT USERSBL'
